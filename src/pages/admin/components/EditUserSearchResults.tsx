    ...
    <>
      {results.map((u) => (
        <button
          ...
          hx-swap="afterend"
          class={cn(
            "flex w-full flex-wrap items-center justify-between gap-2 border-b border-slate-500 p-3 text-left",
        ...
        >
          ...
          <div
            class={cn(
              "pointer-events-none flex shrink-0 items-center gap-2 text-gray-300",
            )}
          >
            <EditIcon />
